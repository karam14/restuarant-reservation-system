...
export default function OnboardingPage() {
        ...
        >
          <Card>
            <CardContent className="pt-8 pb-8 text-center space-y-6">
              ...
              <div className="bg-muted rounded-lg p-4 text-left font-mono text-sm space-y-1">
                <div>
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-background">
      <Toaster />
      <motion.div
        className="max-w-2xl w-full space-y-6 p-4"
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Nieuw restaurant</h1>
            <p className="text-sm text-muted-foreground">
              Onboard een nieuw restaurant in het systeem
            </p>
          </div>
        </div>
                ...
                {step === 2 && (
                  <>
                    ...
                    <Button
                      ...
                      disabled={
                        testingSmtp || !smtpHost || !smtpUser || !smtpPass
                      }
                      className="w-full"
                    >
                      {testingSmtp ? (
